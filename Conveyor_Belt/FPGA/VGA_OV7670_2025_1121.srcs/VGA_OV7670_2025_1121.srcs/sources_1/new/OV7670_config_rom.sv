...
module OV7670_config_rom_1 (
    ...
    always @(posedge clk) begin
        case (addr)
            ...
            18: dout <= 16'h17_0A;  // HSTART
            19: dout <= 16'h18_01;  // HSTOP
            21: dout <= 16'h19_01;  // VSTART
            22: dout <= 16'h1A_3D;  // VSTOP
            ...
            34: dout <= 16'h70_3a;  // X scaling
            35: dout <= 16'h71_35;  // Y scaling
            36: dout <= 16'h72_11;  // DCW control
            37: dout <= 16'h73_f1;  // PCLK scaling
            38: dout <= 16'ha2_02;
            //gamma curve values
            39: dout <= 16'h7a_20;
            40: dout <= 16'h7b_10;
            ...
            //AGC and AEC
            55:
            dout <= 16'h13_e0;  // COM8: AEC, AGC, AWB 모두 OFF (수동 모드 전환)
            56:
            dout <= 16'h00_40;  // GAIN: 증폭값 설정 (00~7F). 화면이 너무 어두우면 값을 올리세요.
            57: dout <= 16'h10_08;  // AECH: 노출 시간 (셔터 스피드). 
                                    // 값을 낮출수록(예: 05) 잔상은 사라지지만 화면이 어두워집니다.
            58: dout <= 16'h0d_40;  // COM4: 기본 매직 넘버 유지
            59: dout <= 16'h14_18;  // COM9: 최대 게인 설정 유지

            60: dout <= 16'ha5_05;  // BD50MAX
            61: dout <= 16'hab_07;  // DB60MAX
            62: dout <= 16'h24_95;  // AGC 상한
            63: dout <= 16'h25_33;  // AGC 하한
            64: dout <= 16'h26_e3;  // AGC/AEC Fast 모드
            ...
            // 마지막 확인: 자동 기능이 다시 켜지지 않도록 e0 유지
            73: dout <= 16'h13_e0;  // COM8: 수동 모드 고정
            74: dout <= 16'h69_07;  // GFIX: Gain 제어 관련
